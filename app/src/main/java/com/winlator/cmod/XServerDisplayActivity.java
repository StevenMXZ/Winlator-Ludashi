...
// --- MOTOR ANTIGO (Busca no seu CMOD) ---
import com.winlator.cmod.xserver.ScreenInfo;
import com.winlator.cmod.xserver.XServer;
import com.winlator.cmod.widget.XServerView; 

// --- MOTOR NOVO (Busca na Embaixada) ---
...
public class XServerDisplayActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (useXlorie) {
            ...
            // Inicializa XServer Clássico (CMOD)
        ...
        // ATENÇÃO: Se der erro no método setTouchInputHandler, avise! 
        // O InputControlsView do Bionic pode não ter suporte nativo a isso.
        if (useXlorie) {
