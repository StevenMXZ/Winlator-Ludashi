...
public class XServerDisplayActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (useXlorie) {
            ...
            xServer = new XServer(new ScreenInfo(String.valueOf(getWindowManager().getDefaultDisplay().getDisplayId()))); 
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        // Métodos onKeyEvent removidos pois não existem no Bionic InputManager
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent event) {
        // Métodos onGenericMotionEvent removidos pois não existem no Bionic InputManager
