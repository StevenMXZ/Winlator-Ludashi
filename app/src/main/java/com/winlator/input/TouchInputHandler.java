...
public class TouchInputHandler {
    ...
    private static class InputStubWrapper implements InputStub {
        ...
        public void sendMouseWheelEvent(float deltaX, float deltaY) {
            if (deltaY > 0) {
                view.sendMouseEvent(0, 0, InputStub.BUTTON_SCROLL_DOWN, true, true);
                view.sendMouseEvent(0, 0, InputStub.BUTTON_SCROLL_DOWN, false, true);
            } else if (deltaY < 0) {
                view.sendMouseEvent(0, 0, InputStub.BUTTON_SCROLL_UP, true, true);
                view.sendMouseEvent(0, 0, InputStub.BUTTON_SCROLL_UP, false, true);
            }
        }
