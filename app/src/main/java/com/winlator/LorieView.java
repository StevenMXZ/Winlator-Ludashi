...
public class LorieView extends SurfaceView implements InputStub {
    public final TouchInputHandler inputHandler;
    ...
    public LorieView(Context context) { 
        super(context); 
        this.inputHandler = new TouchInputHandler(getActivity(), this);
        init(); 
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (inputHandler != null) {
            inputHandler.handleTouchEvent(this, this, event);
            return true;
        }
    ...
    public void checkRestartInput(boolean recheck) {
        ...
        if (languageTag != null && languageTag.length() >= 2 && !languageTag.substring(0, 2).equals(mImeLang))
            ...
            postDelayed(() -> checkRestartInput(false), 40);
        }
    }
    @Override
